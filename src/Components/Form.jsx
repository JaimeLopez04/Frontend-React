        ...
        <div className='bg-black/20 backdrop-blur-lg px-24 py-8 rounded-2xl'>
            ...
            <div className='mt-6'>
                ...
                <div className='mt-6 flex flex-col gap-y-4'>
                    ...
                    <button 
                        className='flex items-center justify-center gap-2 active:scale-[.98] active:duration-75 transition-all hover:scale-[1.05]  ease-in-out transform py-2  rounded-xl font-semibold text-lg border-2 border-gray-100 '>
