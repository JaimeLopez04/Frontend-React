...
const GenresCards = () => {
  return (
    <div>
        <a href="#" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:h-32 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-purple2 dark:bg-opacity-20 
        dark:hover:bg-purple dark:hover:bg-opacity-10">
