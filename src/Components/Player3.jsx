...
// Para pasar las canciones
  ...
  return (
    <div>
        <div  className="flex flex-row items-center bg-white border border-gray-200 rounded-lg dark:border-gray-700 dark:bg-black shadow-md shadow-purple2 ">
            <img className="object-cover w-full rounded-t-lg h-24 md:h-24 md:w-24 md:rounded-none md:rounded-l-lg mr-3" 
              src={wave2} 
              alt="music image" />
