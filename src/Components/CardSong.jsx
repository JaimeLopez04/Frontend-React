...
const CardSong = () => {
    return (
        <div className='bg-black/20  backdrop-blur-lg text-center rounded-xl items-center justify-center w-48 m-2'>
            <div className='flex items-center justify-center'>
                <img src={urlImage} alt="Imagen" className='rounded-md object-cover w-32 h-32' />
            </div>
                <div className='p-4 '>
